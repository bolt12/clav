...
onde ($\circ$), denota a composição de relações, \textit{id} é a relação identidade e $\subseteq$ é a inclusão de relações:
...
Literalmente:
\vskip0.2cm
\hskip0.5cm\textit{Se uma c2 pertence à lista consolidada lc e c2 é filho da classe c1, então c1 também pertence à lista consolidada lc.}

\vskip0.2cm
Ainda em menos palavras, a restrição \eqref{eq-inv1}, sugere:
\vskip0.2cm
\hskip0.5cm\textit{Filho de quem pertence, também pertence.}
